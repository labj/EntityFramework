...
namespace EntityFramework.Controllers
{
    public class StudentCoursesController : Controller
    {
        ...
        {
            var schoolDbContext = _context.StudentCourses.Include(s => s.Course).Include(s => s.Student);
        ...
        {
            ViewData["CourseId"] = new SelectList(_context.Courses, "CourseId", "Subject");
        ...
        public async Task<IActionResult> Create([Bind("StudentId,CourseId")] StudentCourse studentCourse)
        {
            ...
            ViewData["CourseId"] = new SelectList(_context.Courses, "CourseId", "Subject", studentCourse.CourseId);
